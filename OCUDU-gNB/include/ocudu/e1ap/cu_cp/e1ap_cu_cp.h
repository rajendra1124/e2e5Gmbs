...
/// Handle E1AP multicast bearer context management procedures as defined in TS 38.463 section 8.10.
class e1ap_mbs_bearer_context_manager
{
public:
  virtual ~e1ap_mbs_bearer_context_manager() = default;

  /// \brief Initiates the MCBearerContextSetup procedure.
  virtual void
  handle_mbs_bearer_context_setup_request(const e1ap_mbs_bearer_context_setup_request& request) = 0;

  /// \brief Initiates the MCBearerContextModification procedure.
  virtual void handle_mbs_bearer_context_modification_request(
      const e1ap_mbs_bearer_context_modification_request& request) = 0;

  /// \brief Initiates the MCBearerContextRelease procedure.
  virtual void
  handle_mbs_bearer_context_release_command(const e1ap_mbs_bearer_context_release_command& command) = 0;
};
...
public:
  ...
  /// \brief Notifies about the reception of an MCBearerContextSetupResponse.
  virtual void on_mbs_bearer_context_setup_response_received(const e1ap_mbs_bearer_context_setup_response& msg) = 0;

  /// \brief Notifies about the reception of an MCBearerContextModificationResponse.
  virtual void on_mbs_bearer_context_modification_response_received(
      const e1ap_mbs_bearer_context_modification_response& msg) = 0;

  /// \brief Notifies about the reception of an MCBearerContextReleaseComplete.
  virtual void on_mbs_bearer_context_release_complete_received(
      const e1ap_mbs_bearer_context_release_complete& msg) = 0;
};
...
class e1ap_cu_cp : public e1ap_message_handler,
                   ...
                   public e1ap_mbs_bearer_context_manager,
...
public:
  ...
  virtual e1ap_mbs_bearer_context_manager&     get_e1ap_mbs_bearer_context_manager()     = 0;

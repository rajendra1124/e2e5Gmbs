...
public:
  ...
  /// \brief Notifies the CU-UP manager to create a multicast bearer context.
  virtual e1ap_mbs_bearer_context_setup_response
  on_mbs_bearer_context_setup_request_received(const e1ap_mbs_bearer_context_setup_request& msg) = 0;

  /// \brief Notifies the CU-UP manager to modify a multicast bearer context.
  virtual e1ap_mbs_bearer_context_modification_response
  on_mbs_bearer_context_modification_request_received(
      const e1ap_mbs_bearer_context_modification_request& msg) = 0;

  /// \brief Notifies the CU-UP manager to release a multicast bearer context.
  virtual e1ap_mbs_bearer_context_release_complete
  on_mbs_bearer_context_release_command_received(const e1ap_mbs_bearer_context_release_command& msg) = 0;

...
public:
  ...
  /// \brief Notifies the CU-CP about an MBS Multicast Session Update Request.
  virtual void on_mbs_session_update_request(const cu_cp_mbs_session_update_request& msg) = 0;

  /// \brief Notifies the CU-CP about an MBS Multicast Session Activation Request.
  virtual void on_mbs_session_activation_request(const cu_cp_mbs_session_activation_request& msg) = 0;

  /// \brief Notifies the CU-CP about an MBS Multicast Session Deactivation Request.
  virtual void on_mbs_session_deactivation_request(const cu_cp_mbs_session_deactivation_request& msg) = 0;

  /// \brief Notifies the CU-CP about an MBS Multicast Group Paging message.
  virtual void on_mbs_group_paging_message(const cu_cp_mbs_group_paging_message& msg) = 0;

...
public:
  ...
  /// \brief Create or update a multicast bearer context and MRB state.
  virtual e1ap_mbs_bearer_context_setup_response
  handle_mbs_bearer_context_setup_request(const e1ap_mbs_bearer_context_setup_request& msg) = 0;

  /// \brief Modify an existing multicast bearer context and MRB state.
  virtual e1ap_mbs_bearer_context_modification_response
  handle_mbs_bearer_context_modification_request(const e1ap_mbs_bearer_context_modification_request& msg) = 0;

  /// \brief Release a multicast bearer context.
  virtual e1ap_mbs_bearer_context_release_complete
  handle_mbs_bearer_context_release_command(const e1ap_mbs_bearer_context_release_command& msg) = 0;

...
public:
  ...
  std::optional<mac_mbs_context_setup_request>              last_mbs_setup;
  std::optional<mac_mbs_context_release_request>            last_mbs_release;
  ...
  mac_mbs_information_handler&         get_mbs_handler() override { return *this; }
  ...
  void handle_mbs_context_setup(const mac_mbs_context_setup_request& request) override { last_mbs_setup = request; }

  void handle_mbs_context_release(const mac_mbs_context_release_request& request) override { last_mbs_release = request; }

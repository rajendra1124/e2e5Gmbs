...
public:
  ...
  {
    last_mbs_modification_response = msg;
  }

  void
  on_mbs_bearer_context_release_complete_received(const e1ap_mbs_bearer_context_release_complete& msg) override
  {
    last_mbs_release_complete = msg;
  }

  ocucp::cu_cp_bearer_context_release_request last_release_request;
  ocucp::cu_cp_inactivity_notification        last_msg;
  e1ap_mbs_bearer_context_setup_response      last_mbs_setup_response;
  e1ap_mbs_bearer_context_modification_response last_mbs_modification_response;
  e1ap_mbs_bearer_context_release_complete    last_mbs_release_complete;

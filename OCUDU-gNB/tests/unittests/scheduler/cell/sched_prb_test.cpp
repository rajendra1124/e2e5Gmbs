...
TEST(bwp_rb_bitmap, search_stays_within_limits)
{
  prb_bitmap used_prbs(52);
  used_prbs.fill(0, 8);
  used_prbs.fill(12, 24);

  TESTASSERT(rb_helper::find_empty_interval_of_length(used_prbs, 8, prb_interval{0, 24}) == prb_interval(8, 12));
}

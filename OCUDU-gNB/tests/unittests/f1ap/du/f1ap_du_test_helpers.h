...
public:
  ...
  std::optional<f1ap_du_mbs_context_setup_request>        last_mbs_context_setup;
  std::optional<f1ap_du_mbs_context_modification_request> last_mbs_context_modification;
  std::optional<f1ap_du_mbs_context_release_request>      last_mbs_context_release;
  std::optional<f1ap_du_mbs_data_request>                 last_mbs_data_pdu;
  ...
  void on_mbs_context_setup(const f1ap_du_mbs_context_setup_request& request) override { last_mbs_context_setup = request; }

  void on_mbs_context_modification(const f1ap_du_mbs_context_modification_request& request) override
  {
    last_mbs_context_modification = request;
  }

  void on_mbs_context_release(const f1ap_du_mbs_context_release_request& request) override
  {
    last_mbs_context_release = request;
  }

  void on_mbs_data_pdu(f1ap_du_mbs_data_request request) override { last_mbs_data_pdu = std::move(request); }

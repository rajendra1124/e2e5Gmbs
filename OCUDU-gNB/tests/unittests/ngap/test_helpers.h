...
public:
  ...
  void on_mbs_session_update_request(const cu_cp_mbs_session_update_request& msg) override
  {
    last_mbs_session_update = msg;
  }

  void on_mbs_session_activation_request(const cu_cp_mbs_session_activation_request& msg) override
  {
    last_mbs_session_activation = msg;
  }

  void on_mbs_session_deactivation_request(const cu_cp_mbs_session_deactivation_request& msg) override
  {
    last_mbs_session_deactivation = msg;
  }

  void on_mbs_group_paging_message(const cu_cp_mbs_group_paging_message& msg) override
  {
    last_mbs_group_paging = msg;
  }
  ...
  std::optional<cu_cp_mbs_session_update_request>            last_mbs_session_update;
  std::optional<cu_cp_mbs_session_activation_request>        last_mbs_session_activation;
  std::optional<cu_cp_mbs_session_deactivation_request>      last_mbs_session_deactivation;
  std::optional<cu_cp_mbs_group_paging_message>              last_mbs_group_paging;

...
public:
  ...
  /// \brief Handle an MBS Multicast Session Update Request received from NGAP.
  virtual void handle_mbs_session_update_request(const cu_cp_mbs_session_update_request& msg) = 0;

  /// \brief Handle an MBS Multicast Session Activation Request received from NGAP.
  virtual void handle_mbs_session_activation_request(const cu_cp_mbs_session_activation_request& msg) = 0;

  /// \brief Handle an MBS Multicast Session Deactivation Request received from NGAP.
  virtual void handle_mbs_session_deactivation_request(const cu_cp_mbs_session_deactivation_request& msg) = 0;

  /// \brief Handle an MBS Multicast Group Paging message received from NGAP.
  virtual void handle_mbs_group_paging_message(const cu_cp_mbs_group_paging_message& msg) = 0;
};
...
public:
  ...
  /// \brief Handle an MBS bearer context setup response from a CU-UP.
  virtual void handle_mbs_bearer_context_setup_response(const e1ap_mbs_bearer_context_setup_response& msg) = 0;

  /// \brief Handle an MBS bearer context modification response from a CU-UP.
  virtual void
  handle_mbs_bearer_context_modification_response(const e1ap_mbs_bearer_context_modification_response& msg) = 0;

  /// \brief Handle an MBS bearer context release complete from a CU-UP.
  virtual void handle_mbs_bearer_context_release_complete(const e1ap_mbs_bearer_context_release_complete& msg) = 0;
};

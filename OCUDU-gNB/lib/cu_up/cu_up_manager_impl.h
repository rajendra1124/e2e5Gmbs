...
public:
  ...
  handle_mbs_bearer_context_setup_request(const e1ap_mbs_bearer_context_setup_request& msg) override;

  e1ap_mbs_bearer_context_modification_response
  handle_mbs_bearer_context_modification_request(const e1ap_mbs_bearer_context_modification_request& msg) override;

  e1ap_mbs_bearer_context_release_complete
  handle_mbs_bearer_context_release_command(const e1ap_mbs_bearer_context_release_command& msg) override;
...
private:
  ...
  std::map<uint32_t, e1ap_mbs_bearer_context> mbs_contexts;
  uint32_t                                    next_cu_up_mbs_e1ap_id = 1;

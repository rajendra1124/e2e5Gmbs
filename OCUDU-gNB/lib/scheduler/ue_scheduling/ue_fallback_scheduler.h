...
private:
  ...
  /// \remark If \c ded_ss is not null, the PDCCH is allocated in this UE-dedicated configured search space instead
  /// of the common RA search space.
  ul_srb_sched_outcome schedule_ul_srb(ue&                                          u,
                                       ...
                                       bool                                         remove_pucch,
                                       const search_space_info*                     ded_ss = nullptr);

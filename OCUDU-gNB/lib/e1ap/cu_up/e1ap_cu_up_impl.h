...
private:
  ...
  /// \brief Notify about the reception of an MBS multicast bearer context setup request message.
  void handle_mbs_bearer_context_setup_request(const asn1::e1ap::mc_bearer_context_setup_request_s& msg);

  /// \brief Notify about the reception of an MBS multicast bearer context modification request message.
  void handle_mbs_bearer_context_modification_request(
      const asn1::e1ap::mc_bearer_context_mod_request_s& msg);

  /// \brief Notify about the reception of an MBS multicast bearer context release command message.
  void handle_mbs_bearer_context_release_command(const asn1::e1ap::mc_bearer_context_release_cmd_s& msg);

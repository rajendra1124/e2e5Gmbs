...
public:
  ...
  void handle_mbs_bearer_context_setup_request(const e1ap_mbs_bearer_context_setup_request& request) override;
  void handle_mbs_bearer_context_modification_request(
      const e1ap_mbs_bearer_context_modification_request& request) override;
  void handle_mbs_bearer_context_release_command(const e1ap_mbs_bearer_context_release_command& command) override;
  ...
  e1ap_mbs_bearer_context_manager&     get_e1ap_mbs_bearer_context_manager() override { return *this; }
...
private:
  ...
  uint32_t next_cu_cp_mbs_e1ap_id = 1;
};
